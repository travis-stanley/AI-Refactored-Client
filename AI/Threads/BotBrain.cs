// <auto-generated>
//   AI-Refactored: BotBrain.cs (Ultimate Headless-Safe Edition, June 2025)
//   Ensures Movement and all AI systems are safely initialized post-owner wiring.
//   Fixes: Init failure, Movement subsystem missing, BotBrain early attach.
//   Bulletproof for headless, client, and host. MIT License.
// </auto-generated>
...
namespace AIRefactored.AI.Threads
{
	...
	public sealed class BotBrain : MonoBehaviour
	{
		...
		public void Initialize(BotOwner bot)
		{
			...
			if (_cache == null || _cache.AIRefactoredBotOwner == null || !_cache.AIRefactoredBotOwner.IsInitialized)
			{
			...
			// Load all systems now that cache is ready
