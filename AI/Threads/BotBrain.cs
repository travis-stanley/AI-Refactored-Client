// <auto-generated>
//   AI-Refactored: BotBrain.cs (Beyond Diamond – Ultimate Realism Edition, June 2025)
	...
	public sealed class BotBrain : MonoBehaviour
	{
		...
		public void Initialize(BotOwner bot)
		{
			...
			try
			{
				...
				if (_cache == null)
				{
					Logger.LogError("[BotBrain] Initialization failed: cache could not be created.");
					enabled = false;
					return;
				}
				...
				if (owner == null)
				{
					Logger.LogError("[BotBrain] Initialization failed: owner not wired in cache.");
					enabled = false;
					return;
				}
