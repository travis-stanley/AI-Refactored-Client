// <auto-generated>
//   AI-Refactored: BotDeadBodyScanner.cs (Beyond Diamond Ultra-Realism Edition)
//   SYSTEMATICALLY MANAGED. Bulletproof, pooling-optimized, null-free, squad-safe, multiplayer/headless compatible.
//   All logic is non-blocking, atomic, and fully personality/context-aware.
//   Realism: Human hesitation, memory, risk-prioritized corpse looting, squad/line-of-sight validation.
//   MIT License.
// </auto-generated>
...
namespace AIRefactored.AI.Looting
{
    ...
    /// <summary>
    /// Scans for and opportunistically loots dead enemies, factoring proximity, line of sight, memory, squad, and risk.
    /// Mimics human looting caution, timing, and limited recall; multiplayer/headless safe. 100% error contained.
    /// </summary>
    public sealed class BotDeadBodyScanner
    {
        ...
        /// <summary>
        /// Associates lootable containers with corpses at runtime for fast lookup.
        /// </summary>
