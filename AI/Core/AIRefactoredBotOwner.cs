// <auto-generated>
//   AI-Refactored: AIRefactoredBotOwner.cs (Final Headless-Safe Sync Edition – June 2025)
//   Bulletproof attach logic using deferred cache lookup and strict SetOwner protection.
//   Prevents all broken bot brains, null personalities, or cache-owner mismatches.
//   MIT License.
// </auto-generated>
...
namespace AIRefactored.AI.Core
{
    ...
    public sealed class AIRefactoredBotOwner
    {
        ...
        public void Initialize(BotOwner bot)
        {
            ...
            try
            {
                // Lookup or defer attach to cache
                BotComponentCacheRegistry.TryGet(id, out _cache);
                if (_cache == null)
                {
                ...
                // Finalize personality assignment
                if (PersonalityProfile == null || ReferenceEquals(PersonalityProfile, BotPersonalityProfile.Default))
                {
                    ...
                    var profile = BotRegistry.GetOrGenerate(id, PersonalityType.Balanced, role);
