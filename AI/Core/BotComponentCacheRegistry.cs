// <auto-generated>
//   AI-Refactored: BotComponentCacheRegistry.cs (Beyond Diamond – Headless Safe Owner-Cache Sync Edition, June 2025)
//   Fixes headless cache/owner desync by enforcing proper order and idempotent registration.
//   Bulletproof: No SetOwner spam, no missing owner, no broken BotBrain.
//   MIT License.
// </auto-generated>
        ...
        public static BotComponentCache GetOrCreate(BotOwner bot)
        {
            ...
            lock (Lock)
            {
                if (CacheMap.TryGetValue(id, out var existing))
                {
                    ...
                    {
                        var recoveredOwner = bot.GetComponent<AIRefactoredBotOwner>() ?? new AIRefactoredBotOwner();
                        existing.SetOwner(recoveredOwner);
                        if (!recoveredOwner.IsInitialized)
                            recoveredOwner.Initialize(bot);
                    }
