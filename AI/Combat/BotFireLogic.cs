// <auto-generated>
//   AI-Refactored: BotFireLogic.cs (Beyond Diamond Edition)
//   Ultimate realism, immersion, and bulletproof logic for AI weapon fire and engagement.
//   All movement/aim uses human-like imperfection, panic, suppression, recoil, personality, and error recovery.
//   No fallback disables. No teleportation. No allocations in hot paths. 
//   Licensed under MIT.
// </auto-generated>
...
namespace AIRefactored.AI.Combat
{
    ...
    /// Integrates suppression, panic, emotional contagion, personality, micro-jitter, realistic misses,
    /// bone targeting, cover bias, squad synchronization, error isolation, and robust pooling.
    ...
    public sealed class BotFireLogic
    {
            ...
            try
            {
                ...
                if (weaponManager.IsWeaponReady)
                {
                    ...
                    if (UnityEngine.Random.value < fireChance)
                    {
                        ...
                        if (_cache.GroupBehavior?.IsInSquad == true && UnityEngine.Random.value < 0.22f)
        ...
        private void UpdateBotAiming(Vector3 aimPosition, BotPersonalityProfile profile, float time)
        {
            try
            {
                ...
                float panicMiss = (1f - composure) * 1.1f;
