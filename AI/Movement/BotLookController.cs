// <auto-generated>
//   AI-Refactored: BotLookController.cs (Beyond Diamond Overlay-Only, Max Realism, June 2025)
//   All look is overlay, smooth, anticipation-aware, never snapped/tick-throttled. No disables, pooled, bulletproof, multiplayer/headless safe.
//   MIT License.
// </auto-generated>
...
namespace AIRefactored.AI.Movement
{
    ...
    /// <summary>
    /// Handles human-style, inertia-based, anticipation-driven look/aim overlays for bots.
    /// All look/aim is smoothly blended, never snaps or disables. Bulletproof tick-only, SPT/FIKA/headless/client parity.
    /// </summary>
    public sealed class BotLookController
    {
        ...
        /// <summary>
        /// Tick called by BotBrain, drives all look overlays. Never tick-throttled.
        /// </summary>
        public void Tick(float deltaTime)
        {
            try
            {
                ...
                // Inertia/velocity-based smoothing
        ...
        /// <summary>
        /// Freezes bot look/aim overlays.
        /// </summary>
        public void FreezeLook() => _frozen = true;

        /// <summary>
        /// Unfreezes bot look/aim overlays.
        /// </summary>
        public void ResumeLook() => _frozen = false;

        /// <summary>
        /// Returns bot look direction (forward vector).
        /// </summary>
        ...
        private Vector3 ResolveLookTarget(Vector3 origin, float deltaTime)
        {
            ...
            // Primary: target enemy (ThreatSelector)
