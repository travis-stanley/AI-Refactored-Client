// <auto-generated>
//   AI-Refactored: AttackHandler.cs (Ultimate Realism – Beyond Diamond, Full Fix Plan Applied)
//   EFT-native nav only, micro-jitter and cover logic enforced, never teleports.
//   Movement validated against NavMesh, distance, y-delta, and anti-door block checks.
//   MIT License.
// </auto-generated>
                ...
                if (needsAdvance && now >= _anticipateUntil)
                {
                        ...
                        (_lastIssuedMove - advancePoint).sqrMagnitude > 0.03f || now - _lastMoveTime > 0.66f)
                    {
                        ...
                        if (!(_cache.Perception?.IsSuppressed ?? false))
                            moveTarget = BotMovementHelper.ApplyMicroDrift(moveTarget, _bot.ProfileId, Time.frameCount, _cache.PersonalityProfile, _bot);
