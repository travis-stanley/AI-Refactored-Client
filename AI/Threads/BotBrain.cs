// <auto-generated>
//   AI-Refactored: BotBrain.cs (Beyond Diamond Edition)
	...
	public sealed class BotBrain : MonoBehaviour
	{
		...
		public void Initialize(BotOwner bot)
		{
			...
			try
			{
				...
				_look = _cache.Look ?? new BotLookController(bot, _cache);      // LookController as 'Look'
		...
		public void Tick(float deltaTime)
		{
			try
			{
				...
				SafeTick(_look, l => l.Tick(deltaTime), "Look"); // All look/aim now driven by LookController
				...
				{
					SafeTick(_fallbackHandler, f => f.Tick(_now, null), "FallbackHandler");
				}
			}
			catch (Exception ex)
			{
