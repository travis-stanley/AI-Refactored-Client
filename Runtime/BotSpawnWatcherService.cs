// <auto-generated>
//   AI-Refactored: BotSpawnWatcherService.cs (Beyond Diamond Atomic Recovery Edition)
//   All polling, validation, and injection is strictly localized. No fallback disables, always retries, atomic cache/owner/brain enforcement.
//   All subsystem failures are strictly isolated; never disables or blacklists any bot.
//   MIT License.
// </auto-generated>
			...
			try
			{
				...
				for (int i = 0; i < players.Count; i++)
				{
					try
					{
						...
						// Already has a brain attached? (including late/async injection)
						if (go.GetComponent<BotBrain>() != null)
							continue;

						// AIData/Owner must be valid before anything else.
						...
						// Wait for complete bot/caches/owner
						...
						// Ensure personality always wired (never allow null)
						...
						// Atomic: Attach BotBrain, then enforce/guard
