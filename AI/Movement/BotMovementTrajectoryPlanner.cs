// <auto-generated>
//   AI-Refactored: BotMovementTrajectoryPlanner.cs (Beyond Diamond, Ultra-Realism & Squad Intelligence, June 2025)
...
namespace AIRefactored.AI.Movement
{
    ...
    public sealed class BotMovementTrajectoryPlanner
    {
        ...
        /// <summary>
        /// Given an intent direction, outputs a fully humanized, squad/context/personality-driven movement vector.
        /// All chaos/avoidance/jitter is internally stateful and pooled.
        /// </summary>
        public Vector3 ModifyTrajectory(Vector3 targetDir, float deltaTime)
        {
            try
            {
                ...
                // Personality/chaos micro-jitter
                ...
                // Human anticipation (overshoot, fake start, etc.)
                TryAnticipation(baseDir, now, ref adjusted);

                // Squad formation path bias (shared squad move path)
                if (_cache.SquadPath != null)
                {
                    ...
                    // Lateral/edge bias to keep squads from "clumping"
                ...
                // Dynamic avoidance from teammates (no collisions)
                ...
                // Role/position bias for squad movement variety
                ...
                // Adapt to cover (hug wall/cover alignment)
                ...
                // Bias to current movement velocity for inertia realism
                ...
                // Suppressed/panicking chaos (high randomness)
