    ...
    public class HotspotSystem : MonoBehaviour
    {
        private sealed class HotspotSession
        {
            ...
            private float GetSwitchInterval()
            {
                ...
                {
                    case PersonalityType.Cautious: return 160f;
                    case PersonalityType.TeamPlayer: return 100f;
                    case PersonalityType.Strategic: return 90f;
                    case PersonalityType.Explorer: return 75f;
                    case PersonalityType.Dumb: return 45f;
                    default: return 120f;
                }
            }
        ...
        private readonly Dictionary<BotOwner, HotspotSession> _sessions = new Dictionary<BotOwner, HotspotSession>();
        private static readonly List<BotOwner> _botList = new List<BotOwner>();
