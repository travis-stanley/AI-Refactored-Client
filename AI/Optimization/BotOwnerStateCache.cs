// <auto-generated>
//   AI-Refactored: BotOwnerStateCache.cs (Beyond Diamond, Stutter/Teleport-Proof Edition)
//   All personality cache/shift logic is bulletproof, fully isolated, realism-optimized, NavMesh-safe, never teleports or stutters.
// </auto-generated>
    ...
    public sealed class BotOwnerStateCache
    {
        ...
        private static void TriggerZoneShift(BotOwner botOwner, bool? advance, float length, float delay)
        {
            try
            {
                ...
                if (shift.sqrMagnitude > SafeMoveMax * SafeMoveMax)
                {
                    shift = shift.normalized * SafeMoveMax;
                }
                else if (shift.sqrMagnitude < SafeMoveMin * SafeMoveMin)
                {
                ...
                if (shift.sqrMagnitude > 0.02f)
                {
                    ...
                    // NavMesh sample (no teleport, never off-mesh)
