// <auto-generated>
//   AI-Refactored: BotBrain.cs (Beyond Diamond – Headless Deferred Init Fix, June 2025)
//   Fixes FIKA headless desync and Movement subsystem missing issues.
//   Deferred cache owner readiness detection, retry via Update() loop.
//   MIT License.
// </auto-generated>
	...
	public sealed class BotBrain : MonoBehaviour
	{
		...
		public void Initialize(BotOwner bot)
		{
			...
			try
			{
				...
				if (_cache == null || !_cache.IsReady || _cache.AIRefactoredBotOwner == null || !_cache.AIRefactoredBotOwner.IsInitialized)
				{
					Logger.LogWarning("[BotBrain] Init failed: cache/owner not ready.");
					enabled = false;
					_initDeferred = false; // allow retry
					return;
				}
				...
				if (_movement == null)
				{
					Logger.LogWarning("[BotBrain] Movement subsystem still missing after init.");
					enabled = false;
					_initDeferred = false;
					return;
				}
			...
			{
				Logger.LogError("[BotBrain] Initialize error: " + ex);
				enabled = false;
			}
		}
		...
		private void Update()
		{
			if (!_initialized && !_initDeferred && _bot != null)
			{
				_initDeferred = true;
				Initialize(_bot);
			}
		...
		public void Tick(float deltaTime)
		{
			try
			{
				if (!_initialized || _bot == null || _player == null || _bot.IsDead || _player.HealthController == null || !_player.HealthController.IsAlive)
					return;
